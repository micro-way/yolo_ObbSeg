...
def main():
    ...
    #
    # model.train(data='yoloobb-data\\3474data_obb.yaml', epochs=100, imgsz=1024, batch=3*4, workers=6*2, patience=2000, )
    ...
    model.train(data='yoloobb-data\\data_obb_seg.yaml', epochs=10, imgsz=1024, batch=3*4, workers=6*2,
                patience=200,
                )
