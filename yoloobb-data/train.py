...
def main():
    ...
    # model.train(data='yoloobb-data\\data_obb_seg.yaml', epochs=5, imgsz=1024, batch=2, workers=6, patience=2000, )
    # obb_seg
    model = YOLO('ultralytics\\cfg\\models\\v8\\yolov8-obb_seg.yaml', task="obb_seg")
    # # 3474data_obb_seg.yaml
    model.train(data='yoloobb-data\\data_obb_seg.yaml', epochs=50, imgsz=1024, batch=2, workers=6, patience=200,
                )
